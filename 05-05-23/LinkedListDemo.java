...
public class LinkedListDemo {
	...
	public static void main(String[] args) {
		...
		names.addFirst("Akshad");//adding at first position
		names.addLast("Sanap"); //adding at last position
		names.add(3, "Pranjal"); //adding at index 2
		System.out.println(names);
		...
		names.remove("Piyush"); //removing using the index

		System.out.println(names);
		
		//set and get 
		System.out.println();
		names.set(1 ,  "Omkar Dhamale");
		names.set(2, "Kalyani Avhad");
...
//		System.out.println(names);
		...
		names.add("Kalyani");
		System.out.println(names);
		System.out.println(names.lastIndexOf("Kalyani"));
